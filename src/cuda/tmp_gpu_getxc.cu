...
*/
	...
	for(int jatm=0;jatm<devSim_dft.natom;jatm++){
		...
		if(jatm != iparent-1){
			...
			wtgrad[jstart+0] = wtgrad[jstart+0] + uw_iparent*dmudx*t/sumUW;
			wtgrad[jstart+1] = wtgrad[jstart+1] + uw_iparent*dmudy*t/sumUW;
			wtgrad[jstart+2] = wtgrad[jstart+2] + uw_iparent*dmudz*t/sumUW;
...
/*        for(int i=0;i<devSim_dft.natom*3;i++){
			...
			for(int latm=0; latm<devSim_dft.natom;latm++){
				if(latm != jatm){
					...
					wtgrad[jstart+0] = wtgrad[jstart+0] - uw_latm*uw_iparent*dmudx*t/pow(sumUW,2);
					wtgrad[jstart+1] = wtgrad[jstart+1] - uw_latm*uw_iparent*dmudy*t/pow(sumUW,2);
					wtgrad[jstart+2] = wtgrad[jstart+2] - uw_latm*uw_iparent*dmudz*t/pow(sumUW,2);
				}
			}
			...
			for(int latm=0; latm<devSim_dft.natom;latm++){
				if(latm != jatm){
					...
					wtgrad[jstart+0] = wtgrad[jstart+0] + uw_jatm*uw_iparent*dmudx*t/pow(sumUW,2);
					wtgrad[jstart+1] = wtgrad[jstart+1] + uw_jatm*uw_iparent*dmudy*t/pow(sumUW,2);
					wtgrad[jstart+2] = wtgrad[jstart+2] + uw_jatm*uw_iparent*dmudz*t/pow(sumUW,2);
				}
			}

		wtgrad[istart+0] = wtgrad[istart+0]-wtgrad[jstart+0];
		wtgrad[istart+1] = wtgrad[istart+1]-wtgrad[jstart+1];
		wtgrad[istart+2] = wtgrad[istart+2]-wtgrad[jstart+2];
