!---------------------------------------------------------------------!
! Created by Madu Manathunga on 04/26/2020                            !
!                                                                     !
...
#ifdef OSHELL
module quick_oshell_grad_module
#else
module quick_cshell_grad_module
#endif
...
#ifdef OSHELL
subroutine oshell_grad
#else
subroutine cshell_grad
#endif
   use allmod
...
#ifdef OSHELL
end subroutine oshell_grad
#else
end subroutine cshell_grad
#endif
...
#ifdef OSHELL
end module quick_oshell_grad_module
#else
end module quick_cshell_grad_module
#endif
