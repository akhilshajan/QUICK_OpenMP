...
subroutine mpw91(p,gx,gy,gz,gotherx,gothery,gotherz, &
   ...
   ! the derivative of the mpw91 functional with regard to the density
   ! and the derivatives with regard to the gradient invariants.


   fourPi= 12.5663706143591729538505735331d0

   Beta = 5.d0*(fourpi*9.d0)**(-5.d0/3.d0)
   b = .00426d0
   c = 1.6455d0
   d = 3.72d0
   Ax = -(3.d0/2.d0)*(3.d0/fourPi)**(1.d0/3.d0)

   gaa = (gx*gx+gy*gy+gz*gz)
   x = Dsqrt(gaa)*p**(-4.d0/3.d0)

   top = b*x*x - (b-Beta)*x*x*Dexp(-c*x*x)-(1.d-6)*x**d

   bottom=1.d0+6.d0*b*x*Dlog(x+DSQRT(x*x+1.d0)) &
         -1.d-6/Ax*x**d

   dtopdr =  (d*(x)**d)/ (7.5D5*p ) + (8.d0*gaa* &
         (-(b*p **(8.d0/3.d0)) + ((b - Beta)* &
         (-(c*gaa) + p **(8.d0/3.d0)))/ DEXP(c*x*x)))/ &
         (3.d0*p **(19.d0/3.d0))

   dtopdgg = b/p**(8.d0/3.d0) + &
         ((-b + Beta)*(-(c*gaa) + p**(8.d0/3.d0)))/ &
         (DEXP(c*x**2.d0)*p**(16.d0/3.d0)) - &
         (d*x**(-1.d0 + d))/ &
         (2.D6*DSqrt(gaa)*p**(4.d0/3.d0))

   dbottomdr =  (d*x**d)/(7.5d5*Ax*p) - &
         (8.d0*b*x**2.d0)/(p*DSqrt(1.d0 + x**2.d0)) - &
         (8.d0*b*x*Log(x + DSqrt(1.d0 + x**2.d0)))/p

   dbottomdgaa =   -(d*x**(-1.d0 + d))/ &
         (2.D6*Ax*DSqrt(gaa)*p**(4.d0/3.d0)) + &
         (3.d0*b)/(p**(8.d0/3.d0)*DSqrt(1.d0 + x**2.d0)) + &
         (3.d0*b*Log(x + DSqrt(1.d0 + x**2.d0)))/ &
         (Sqrt(gaa)*p**(4.d0/3.d0))

   capF = top/bottom

   dcapFdr = (bottom*dtopdr - top * dbottomdr)/(bottom*bottom)

   dcapFdgg = (bottom*dtopdgg - top * dbottomdgaa)/(bottom*bottom)

   dfdr = ((4.d0/3.d0)*p**(1.d0/3.d0))*(Ax - capF) &
         - (p**(4.d0/3.d0)) * dcapFdr

   dfdgg = -(p**(4.d0/3.d0))*dcapFdgg
...
subroutine mpw91_e(pa,pb,gax,gay,gaz,gbx,gby,gbz,e)
   implicit double precision(a-h,o-z)
   ...
   xLSD = Ax*(pa**(4.d0/3.d0) + pb**(4.d0/3.d0))

   xa = Dsqrt(gax*gax+gay*gay+gaz*gaz)*pa**(-4.d0/3.d0)
   topa = b*xa*xa - (b-Beta)*xa*xa*Dexp(-c*xa*xa)-1.d-6*xa**d
   bottoma=1.d0+6.d0*b*xa*Dlog(xa+DSQRT(xa*xa+1.d0)) &
         -1.d-6/Ax*xa**d
   Fa = topa/bottoma

   e = xLSD - pa**(4.d0/3.d0)*Fa

   if (dabs(pb) < 1.d-10) return

   xb = Dsqrt(gbx*gbx+gby*gby+gbz*gbz)*pb**(-4.d0/3.d0)
   topb = b*xb*xb - (b-Beta)*xb*xb*Dexp(-c*xb*xb)-1.d-6*xb**d
   bottomb=1.d0+6.d0*b*xb*Dlog(xb+DSQRT(xb*xb+1.d0)) &
         -1.d-6/Ax*xb**d
   Fb = topb/bottomb
   e = e - pb**(4.d0/3.d0)*Fb
...
subroutine gridform(iang)
   ...
   if (IANG <= 6) then
      ...
      iang=86
      elseif (IANG <= 110) then
      CALL LD0110(XANG,YANG,ZANG,WTANG,N)
      iang=110
      elseif (IANG <= 146) then
      CALL LD0146(XANG,YANG,ZANG,WTANG,N)
      iang=146
      elseif (IANG <= 170) then
      CALL LD0170(XANG,YANG,ZANG,WTANG,N)
      iang=170
      elseif (IANG <= 194) then
      CALL LD0194(XANG,YANG,ZANG,WTANG,N)
      iang=194
      elseif (IANG <= 230) then
      CALL LD0230(XANG,YANG,ZANG,WTANG,N)
      iang=230
      elseif (IANG <= 266) then
      CALL LD0266(XANG,YANG,ZANG,WTANG,N)
      iang=266
      elseif (IANG <= 302) then
      CALL LD0302(XANG,YANG,ZANG,WTANG,N)
      iang=302
      elseif (IANG <= 350) then
      CALL LD0350(XANG,YANG,ZANG,WTANG,N)
      iang=350
      elseif (IANG <= 434) then
      CALL LD0434(XANG,YANG,ZANG,WTANG,N)
      iang=434
      elseif (IANG <= 590) then
      CALL LD0590(XANG,YANG,ZANG,WTANG,N)
      iang=590
      elseif (IANG <= 770) then
      CALL LD0770(XANG,YANG,ZANG,WTANG,N)
      iang=770
      elseif (IANG <= 974) then
      CALL LD0974(XANG,YANG,ZANG,WTANG,N)
      iang=974
      elseif (IANG <= 1202) then
      CALL LD1202(XANG,YANG,ZANG,WTANG,N)
      iang=1202
      elseif (IANG <= 1454) then
      CALL LD1454(XANG,YANG,ZANG,WTANG,N)
      iang=1454
      elseif (IANG <= 1730) then
      CALL LD1730(XANG,YANG,ZANG,WTANG,N)
      iang=1730
      elseif (IANG <= 2030) then
      CALL LD2030(XANG,YANG,ZANG,WTANG,N)
      iang=2030
      elseif (IANG <= 2354) then
      CALL LD2354(XANG,YANG,ZANG,WTANG,N)
      iang=2354
      elseif (IANG <= 2702) then
      CALL LD2702(XANG,YANG,ZANG,WTANG,N)
      iang=2702
      elseif (IANG <= 3074) then
      CALL LD3074(XANG,YANG,ZANG,WTANG,N)
      iang=3074
      elseif (IANG <= 3470) then
      CALL LD3470(XANG,YANG,ZANG,WTANG,N)
      iang=3470
      elseif (IANG <= 3890) then
      CALL LD3890(XANG,YANG,ZANG,WTANG,N)
      iang=3890
      elseif (IANG <= 4334) then
      CALL LD4334(XANG,YANG,ZANG,WTANG,N)
      iang=4334
      elseif (IANG <= 4802) then
      CALL LD4802(XANG,YANG,ZANG,WTANG,N)
      iang=4802
      elseif (IANG <= 5294) then
      CALL LD5294(XANG,YANG,ZANG,WTANG,N)
      iang=5294
      elseif (IANG <= 5810) then
      CALL LD5810(XANG,YANG,ZANG,WTANG,N)
      iang=5810
   endif
...
subroutine gen_oh(code, num, x, y, z, w, a, b, v)
   ...
   ! vd   This subroutine was translated from C to fortran77 by hand.
   ! vd
...
SUBROUTINE LD0006(X,Y,Z,W,N)
   ...
   ! vd   C-code [1] was kindly provided by Dr. Dmitri N. Laikov and
   ! vd   translated into fortran by Dr. Christoph van Wuellen.
   ! vd   This subroutine was translated using a C to fortran77 conversion
   ! vd   tool written by Dr. Christoph van Wuellen.
   ! vd
   ! vd   Users of this code are asked to include reference [1] in their
   ! vd   publications, and in the user- and programmers-manuals
   ! vd   describing their codes.
...
SUBROUTINE LD0230(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV  230-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
...
SUBROUTINE LD0266(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV  266-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
...
SUBROUTINE LD0302(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV  302-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
...
SUBROUTINE LD0350(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV  350-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
...
SUBROUTINE LD0434(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV  434-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
...
SUBROUTINE LD0590(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV  590-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
...
SUBROUTINE LD0770(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV  770-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
...
SUBROUTINE LD0974(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV  974-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
...
SUBROUTINE LD1202(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV 1202-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
...
SUBROUTINE LD1454(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV 1454-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
...
SUBROUTINE LD1730(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV 1730-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
...
SUBROUTINE LD2030(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV 2030-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
...
SUBROUTINE LD2354(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV 2354-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
...
SUBROUTINE LD2702(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV 2702-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
...
SUBROUTINE LD3074(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV 3074-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
...
SUBROUTINE LD3470(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV 3470-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
...
SUBROUTINE LD3890(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV 3890-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
...
SUBROUTINE LD4334(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV 4334-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
...
SUBROUTINE LD4802(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV 4802-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
...
SUBROUTINE LD5294(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV 5294-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
...
SUBROUTINE LD5810(X,Y,Z,W,N)
   ...
   double precision :: A,B,V
   ! W
   ! W    LEBEDEV 5810-POINT ANGULAR GRID
   ! W
   ! vd
   ! vd   This subroutine is part of a set of subroutines that generate
   ! vd   Lebedev grids [1-6] for integration on a sphere. The original
