...
!  stop
!--------------------Madu--------------------------
               call iclass_ub(I,J,K,L,NNA,NNC,NNAB,NNCD)
            enddo
         enddo
      enddo
   enddo
   201 return
end subroutine shell_ub

! Horrizontal recursion and Fock matrix builder by Xiao HE 07/07/07 version
subroutine iclass_ub(I,J,K,L,NNA,NNC,NNAB,NNCD)
   use allmod
            ...
            do JJJ=JJJ1,JJJ2
               do KKK=KKK1,KKK2
                  do LLL=LLL1,LLL2
                     ...
                     DENSEKIX=quick_qm_struct%denseb(KKK,III)
                     DENSEKJX=quick_qm_struct%denseb(KKK,JJJ)
                     DENSELJX=quick_qm_struct%denseb(LLL,JJJ)
                     DENSELIX=quick_qm_struct%denseb(LLL,III)
                     DENSELKX=quick_qm_struct%denseb(LLL,KKK)
                     DENSEJIX=quick_qm_struct%denseb(JJJ,III)
                     ...
                     quick_qm_struct%ob(KKK,III) = quick_qm_struct%ob(KKK,III)-quick_method%x_hybrid_coeff*DENSELJX*Y
                     quick_qm_struct%ob(LLL,III) = quick_qm_struct%ob(LLL,III)-quick_method%x_hybrid_coeff*DENSEKJX*Y
                     quick_qm_struct%ob(JJJ,KKK) = quick_qm_struct%ob(JJJ,KKK)-quick_method%x_hybrid_coeff*DENSELIX*Y
                     quick_qm_struct%ob(JJJ,LLL) = quick_qm_struct%ob(JJJ,LLL)-quick_method%x_hybrid_coeff*DENSEKIX*Y
                     quick_qm_struct%ob(KKK,JJJ) = quick_qm_struct%ob(KKK,JJJ)-quick_method%x_hybrid_coeff*DENSELIX*Y
                     quick_qm_struct%ob(LLL,JJJ) = quick_qm_struct%ob(LLL,JJJ)-quick_method%x_hybrid_coeff*DENSEKIX*Y
...
!--------------------Madu--------------------------
                           ...
                           DENSEJIX=quick_qm_struct%denseb(KKK,III)
                           ...
                           quick_qm_struct%ob(KKK,III) = quick_qm_struct%ob(KKK,III) &
                                -quick_method%x_hybrid_coeff*DENSEJIX*Y
...
!--------------------Madu--------------------------
                           ...
                           DENSEKIX=quick_qm_struct%denseb(KKK,III)
                           DENSEKJX=quick_qm_struct%denseb(KKK,JJJ)
                           DENSEKKX=quick_qm_struct%denseb(KKK,KKK)
                           DENSEJIX=quick_qm_struct%denseb(JJJ,III)
                           ...
                           quick_qm_struct%ob(KKK,III) = quick_qm_struct%ob(KKK,III)-quick_method%x_hybrid_coeff*DENSEKJX*Y
                           quick_qm_struct%ob(KKK,JJJ) = quick_qm_struct%ob(KKK,JJJ)-quick_method%x_hybrid_coeff*DENSEKIX*Y
                           quick_qm_struct%ob(JJJ,KKK) = quick_qm_struct%ob(JJJ,KKK)-quick_method%x_hybrid_coeff*DENSEKIX*Y
!--------------------Madu---------------------------
!write(*,*) "II<JJ and II < KK and KK<LL = false, III<KKK = true"
...
!--------------------Madu--------------------------
                           ...
                           DENSEKIX=quick_qm_struct%denseb(LLL,III)
                           DENSEJIX=quick_qm_struct%denseb(KKK,III) 
                           ...
                           quick_qm_struct%ob(KKK,III) = quick_qm_struct%ob(KKK,III)-quick_method%x_hybrid_coeff*DENSEKIX*Y
                           quick_qm_struct%ob(LLL,III) = quick_qm_struct%ob(LLL,III)-quick_method%x_hybrid_coeff*DENSEJIX*Y
!--------------------Madu---------------------------
!write(*,*) "II<JJ and II < KK and KK<LL = false, III<KKK = true"
!write(*,*) "III<JJJ and KKK<LLL"
!  write(*,'(A52,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3)')&
...
!--------------------Madu--------------------------
                              ...
                              DENSEII=quick_qm_struct%dense(III,III)+quick_qm_struct%denseb(III,III)
                              DENSEJIX=quick_qm_struct%denseb(LLL,III)
                              DENSEIIX=quick_qm_struct%denseb(III,III)
...
!--------------------Madu--------------------------
                             ...
                             ! Find all the (ij|ij) integrals
                              quick_qm_struct%ob(JJJ,III) = quick_qm_struct%ob(JJJ,III)+2.0d0*DENSEJI*Y &
                                -quick_method%x_hybrid_coeff*DENSEJIX*Y
                              quick_qm_struct%ob(JJJ,JJJ) = quick_qm_struct%ob(JJJ,JJJ)-quick_method%x_hybrid_coeff*DENSEIIX*Y
                              quick_qm_struct%ob(III,III) = quick_qm_struct%ob(III,III)-quick_method%x_hybrid_coeff*DENSEJJX*Y
!--------------------Madu---------------------------
!write(*,*) "II<JJ and II < KK and KK<LL = false, III<KKK = false, JJJ<LLL=true"
...
!--------------------Madu--------------------------
                              ...
                              DENSEJI=quick_qm_struct%dense(JJJ,III)+quick_qm_struct%denseb(JJJ,III)
                              DENSEKIX=quick_qm_struct%denseb(LLL,III)
                              DENSEKJX=quick_qm_struct%denseb(LLL,JJJ)
                              DENSEIIX=quick_qm_struct%denseb(III,III)
                              DENSEJIX=quick_qm_struct%denseb(JJJ,III)

                              ! Find all the (ij|ik) integrals where j>i,k>j
                              quick_qm_struct%ob(JJJ,III) = quick_qm_struct%ob(JJJ,III)+2.0d0*DENSEKI*Y &
                                -quick_method%x_hybrid_coeff*DENSEKIX*Y
                              quick_qm_struct%ob(LLL,III) = quick_qm_struct%ob(LLL,III)+2.0d0*DENSEJI*Y &
                                - quick_method%x_hybrid_coeff*DENSEJIX*Y
!EORD
                             quick_qm_struct%ob(III,III) = quick_qm_struct%ob(III,III)-quick_method%x_hybrid_coeff*1.d0*DENSEKJX*Y &
                                                           -quick_method%x_hybrid_coeff*1.d0*DENSEKJX*Y
                              quick_qm_struct%ob(LLL,JJJ) = quick_qm_struct%ob(LLL,JJJ)-quick_method%x_hybrid_coeff*DENSEIIX*Y
!--------------------Madu---------------------------
!write(*,*) "II<JJ and II < KK and KK<LL = false, III<KKK = false, JJJ<LLL=true"
