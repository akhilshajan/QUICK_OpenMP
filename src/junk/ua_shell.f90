...
!  stop
!--------------------Madu--------------------------
               call iclass_ua(I,J,K,L,NNA,NNC,NNAB,NNCD)
            enddo
         enddo
      enddo
   enddo
   201 return
end subroutine shell_ua

! Horrizontal recursion and Fock matrix builder by Xiao HE 07/07/07 version
subroutine iclass_ua(I,J,K,L,NNA,NNC,NNAB,NNCD)
   use allmod
            ...
            do JJJ=JJJ1,JJJ2
               do KKK=KKK1,KKK2
                  do LLL=LLL1,LLL2
                     ...
                     DENSEKIX=quick_qm_struct%dense(KKK,III)
                     DENSEKJX=quick_qm_struct%dense(KKK,JJJ)
                     DENSELJX=quick_qm_struct%dense(LLL,JJJ)
                     DENSELIX=quick_qm_struct%dense(LLL,III)
                     DENSELKX=quick_qm_struct%dense(LLL,KKK)
                     DENSEJIX=quick_qm_struct%dense(JJJ,III)
                     ...
                     quick_qm_struct%o(KKK,III) = quick_qm_struct%o(KKK,III)-quick_method%x_hybrid_coeff*DENSELJX*Y
                     quick_qm_struct%o(LLL,III) = quick_qm_struct%o(LLL,III)-quick_method%x_hybrid_coeff*DENSEKJX*Y
                     quick_qm_struct%o(JJJ,KKK) = quick_qm_struct%o(JJJ,KKK)-quick_method%x_hybrid_coeff*DENSELIX*Y
                     quick_qm_struct%o(JJJ,LLL) = quick_qm_struct%o(JJJ,LLL)-quick_method%x_hybrid_coeff*DENSEKIX*Y
                     quick_qm_struct%o(KKK,JJJ) = quick_qm_struct%o(KKK,JJJ)-quick_method%x_hybrid_coeff*DENSELIX*Y
                     quick_qm_struct%o(LLL,JJJ) = quick_qm_struct%o(LLL,JJJ)-quick_method%x_hybrid_coeff*DENSEKIX*Y
...
!--------------------Madu--------------------------
                           ...
                           DENSEJIX=quick_qm_struct%dense(KKK,III)
...
!--------------------Madu--------------------------
                           ...
                           DENSEJIX=quick_qm_struct%dense(JJJ,III)
                           DENSEJJX=quick_qm_struct%dense(JJJ,JJJ)
...
!--------------------Madu--------------------------
                           ...
                           DENSEKIX=quick_qm_struct%dense(KKK,III)
                           DENSEKJX=quick_qm_struct%dense(KKK,JJJ)
                           DENSEKKX=quick_qm_struct%dense(KKK,KKK)
                           DENSEJIX=quick_qm_struct%dense(JJJ,III)
                           ...
                           quick_qm_struct%o(KKK,III) = quick_qm_struct%o(KKK,III)-quick_method%x_hybrid_coeff*DENSEKJX*Y
                           quick_qm_struct%o(KKK,JJJ) = quick_qm_struct%o(KKK,JJJ)-quick_method%x_hybrid_coeff*DENSEKIX*Y
                           quick_qm_struct%o(JJJ,KKK) = quick_qm_struct%o(JJJ,KKK)-quick_method%x_hybrid_coeff*DENSEKIX*Y
!--------------------Madu---------------------------
!write(*,*) "II<JJ and II < KK and KK<LL = false, III<KKK = true"
...
!--------------------Madu--------------------------
                           ...
                           DENSEKIX=quick_qm_struct%dense(LLL,III)
                           DENSEJIX=quick_qm_struct%dense(KKK,III)                          
                           ...
                           quick_qm_struct%o(KKK,III) = quick_qm_struct%o(KKK,III)-quick_method%x_hybrid_coeff*DENSEKIX*Y
                           quick_qm_struct%o(LLL,III) = quick_qm_struct%o(LLL,III)-quick_method%x_hybrid_coeff*DENSEJIX*Y
!--------------------Madu---------------------------
!write(*,*) "II<JJ and II < KK and KK<LL = false, III<KKK = true"
!write(*,*) "III<JJJ and KKK<LLL"
!  write(*,'(A52,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3)')&
...
!--------------------Madu--------------------------
                        ...
                        if(JJJ.LE.LLL)then
                           ...
                           if(III.eq.JJJ.and.III.eq.KKK.and.III.eq.LLL)then
                              DENSEII=quick_qm_struct%dense(III,III)+quick_qm_struct%denseb(III,III)
                              DENSEIIX=quick_qm_struct%dense(III,III)
...
!--------------------Madu--------------------------
                              ...
                              DENSEII=quick_qm_struct%dense(III,III)+quick_qm_struct%denseb(III,III)
                              DENSEJIX=quick_qm_struct%dense(LLL,III)
                              DENSEIIX=quick_qm_struct%dense(III,III)
...
!--------------------Madu--------------------------
                             ...
                             ! Find all the (ij|ij) integrals
                              quick_qm_struct%o(JJJ,III) = quick_qm_struct%o(JJJ,III)+2.0d0*DENSEJI*Y &
                                -quick_method%x_hybrid_coeff*DENSEJIX*Y
                              quick_qm_struct%o(JJJ,JJJ) = quick_qm_struct%o(JJJ,JJJ)-quick_method%x_hybrid_coeff*DENSEIIX*Y
                              quick_qm_struct%o(III,III) = quick_qm_struct%o(III,III)-quick_method%x_hybrid_coeff*DENSEJJX*Y
!--------------------Madu---------------------------
!write(*,*) "II<JJ and II < KK and KK<LL = false, III<KKK = false, JJJ<LLL=true"
...
!--------------------Madu--------------------------
                              ...
                              DENSEJI=quick_qm_struct%dense(JJJ,III)+quick_qm_struct%denseb(JJJ,III)
                              DENSEKIX=quick_qm_struct%dense(LLL,III)
                              DENSEKJX=quick_qm_struct%dense(LLL,JJJ)
                              DENSEIIX=quick_qm_struct%dense(III,III)
                              DENSEJIX=quick_qm_struct%dense(JJJ,III)
                              ...
                              quick_qm_struct%o(LLL,III) = quick_qm_struct%o(LLL,III)+2.0d0*DENSEJI*Y &
                                - quick_method%x_hybrid_coeff*DENSEJIX*Y
!EORD
                              quick_qm_struct%o(III,III) = quick_qm_struct%o(III,III)-quick_method%x_hybrid_coeff*1.d0*DENSEKJX*Y &
                                                           -quick_method%x_hybrid_coeff*1.d0*DENSEKJX*Y
                              quick_qm_struct%o(LLL,JJJ) = quick_qm_struct%o(LLL,JJJ)-quick_method%x_hybrid_coeff*DENSEIIX*Y
!--------------------Madu---------------------------
!write(*,*) "II<JJ and II < KK and KK<LL = false, III<KKK = false, JJJ<LLL=true"
